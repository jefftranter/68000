...
*F	DC.W	SEMIS
	...
	DC.B	$80+'D'
	DC.W	MESS-$0A
LLOAD	DC.W	DOCOL,LBLK
	DC.W	AT,TOR
	DC.W	INN,AT
	DC.W	TOR,ZERO
	DC.W	INN,LSTORE
	DC.W	BSCR,STAR
	DC.W	LBLK,LSTORE	* BLK <- SCR * B/SCR
