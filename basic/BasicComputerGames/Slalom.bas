...
670 NEXT O
680 PRINT:PRINT "YOU TOOK";(T+RND(0));" SECONDS."
690 LET M=T
700 LET M=M/V
...
957 PRINT
960 GOTO 1470
970 PRINT "YOU'VE TAKEN";(T+RND(0));" SECONDS."
980 GOTO 580
990 ON O1 GOTO 1130,1010,1170,1080,1190,1100,1150,1210
1000 STOP
1010 LET S=S+INT(RND(0)*(5-3)+3)
1020 PRINT S;" M.P.H."
...
1080 PRINT S;" M.P.H."
1090 GOTO 1030
1100 LET S=S-INT(RND(0)*(5-3)+3)
1110 PRINT S;" M.P.H."
1120 GOTO 1030
1130 LET S=S+INT(RND(0)*(10-5)+5)
1140 GOTO 1080
1150 LET S=S-INT(RND(0)*(10-5)+5)
1160 GOTO 1110
1170 LET S=S+INT(RND(0)*(4-1)+1)
1180 GOTO 1110
1190 LET S=S-INT(RND(0)*(4-1)+1)
1200 GOTO 1110
1210 PRINT "***CHEAT"
1220 IF RND(0)<.7 THEN 1260
1230 PRINT "YOU MADE IT!"
1240 LET T=T+1.5
1250 RETURN
1260 PRINT "AN OFFICIAL CAUGHT YOU!"
1270 PRINT "YOU TOOK";(T+RND(0));" SECONDS."
1280 GOTO 740
1290 IF RND(0)<((S-Q)*.1)+.2 THEN 1320
1300 PRINT "YOU WENT OVER THE NAXIMUM SPEED AND MADE IT!"
1310 RETURN
1320 PRINT "YOU WENT OVER THE MAXIMUM SPEED AND ";
1330 IF RND(0)<.5 THEN 1370
1340 PRINT "WIPED OUT!"
1350 PRINT "YOU TOOK";(T+RND(0));" SECONDS"
1360 GOTO 740
