...
560 LET P=1
580 LET X=40+(1-P)*20
590 LET Y=INT(200*(RND(0)-.5)^3+55)
600 PRINT Y;L$(3);" KICKOFF"
610 LET X=X-FNF(1)*Y
620 IF ABS(X-50)>=50 THEN 700
630 LET Y=INT(50*RND(0)^2)+(1-P)*INT(50*RND(0)^4)
640 LET X=X+FNF(1)*Y
