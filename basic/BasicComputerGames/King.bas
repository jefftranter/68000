...
46 PRINT "GOOD LUCK!"
47 PRINT
50 A=INT(60000+(1000*RND(0))-(1000*RND(0)))
55 B=INT(500+(10*RND(0))-(10*RND(0)))
65 D=2000
100 W=INT(10*RND(0)+95)
102 PRINT
105 PRINT "YOU NOW HAVE ";A;" RALLODS IN THE TREASURY."
110 PRINT INT(B);:PRINT " COUNTRYMEN, ";
115 V9=INT(((RND(0)/2)*10+10))
120 IF C=0 THEN 140
...
1220 C1=INT(H+(RND(0)*10)-(RND(0)*20))
...
1290 B=INT(B+P1)
1292 C=INT(C+C1)
1305 U2=INT(((2000-D)*((RND(0)+1.5)/2)))
