...
261 LET E1=INT((.15*RND(0)+.95)*10^2+.5)/10^2
262 LET B1=INT((.25*RND(0)+1.00)*10^2+.5)/10^2
300 PRINT
...
1206 LET E1=INT((.15*RND(0)+.8)*10^2+.5)/10^2
1207 LET B1=INT((.2*RND(0)+.9)*10^2+.5)/10^2
...
1263 LET D1=INT((.25*RND(0)+1.1)*10^2+.5)/10^2
