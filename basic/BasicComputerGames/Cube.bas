...
390 IF A<>0 THEN 410
400 LET A=3
410 LET B=INT(3*(RND(0)))
420 IF B<>0 THEN 440
430 LET B=2
440 LET C=INT(3*(RND(0)))
450 IF C<>0 THEN 470
460 LET C=3
470 LET D=INT(3*(RND(0)))
480 IF D<>0 THEN 500
490 LET D=1
500 LET E=INT(3*(RND(0)))
510 IF E<>0 THEN 530
520 LET E=3
530 LET F=INT(3*(RND(0)))
540 IF F<>0 THEN 560
550 LET F=3
560 LET G=INT(3*(RND(0)))
570 IF G<>0 THEN 590
580 LET G=3
590 LET H=INT(3*(RND(0)))
600 IF H<>0 THEN 620
610 LET H=3
620 LET I=INT(3*(RND(0)))
630 IF I<>0 THEN 650
640 LET I=2
650 LET J=INT(3*(RND(0)))
660 IF J<>0 THEN 680
670 LET J=3
680 LET K=INT(3*(RND(0)))
690 IF K<>0 THEN 710
700 LET K=2
710 LET L=INT(3*(RND(0)))
720 IF L<>0 THEN 740
730 LET L=3
740 LET M=INT(3*(RND(0)))
750 IF M<>0 THEN 770
760 LET M=3
770 LET N=INT(3*(RND(0)))
780 IF N<>0 THEN 800
790 LET N=1
