...
770 D1=INT(((30-H)*2.5+187-((30-H)*.25+15)*C/2)+25*RND(0))
780 D1=INT(D1*W)
800 IF T=2 THEN 1170
830 O=(RND(0)/.8)*(2*H+16)*ABS(TAN(D1*.0035))
...
1300 D2=1+(3*INT((80/(40-H))*RND(0)))
1310 GOTO 1380
1320 IF RND(0)>N THEN 1360
1330 N=N*.2
